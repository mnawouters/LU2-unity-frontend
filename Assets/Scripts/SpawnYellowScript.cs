...
public class SpawnYellowScript : MonoBehaviour
{
    ...
    public void Spawn()
    {
        GameObject gespawnd = Instantiate(Yellow, Vector3.zero, Quaternion.identity, WorldManager.Instance.CurrentWorld.transform);
