...
public class SpawnPigScript : MonoBehaviour
{
    ...
    public void Spawn()
    {
        GameObject gespawnd = Instantiate(Pig, Vector3.zero, Quaternion.identity, WorldManager.Instance.CurrentWorld.transform);
